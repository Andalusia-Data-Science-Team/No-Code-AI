...
grid_dict= {'SVC': svc_param_grid, 'LR': lr_param_grid, 'Linear Regression': lreg_param_grid,
              'ElasticNet': en_param_grid, 'KNN_cls': knn_param_grid, 'KNN_reg': knn_param_grid,
              'RF_cls': rf_param_grid, 'XGB_cls': XGB_param_grid, 'XGB_reg': XGB_param_grid,
